...
<body>
	...
	<section class="hero-section overflow-hidden">
		<div class="hero-slider owl-carousel">
			<div class="hero-item set-bg d-flex align-items-center justify-content-center text-center" data-setbg="{{asset('user/img/slider-bg-1.jpg')}}">
				<div class="container">
					<h2>Game on!</h2>
					...
					<a href="#" class="site-btn">Read More  <img src="{{asset('user/img/icons/double-arrow.png')}}" alt="#"/></a>
				</div>
			</div>
			<div class="hero-item set-bg d-flex align-items-center justify-content-center text-center" data-setbg="{{asset('user/img/slider-bg-2.jpg')}}">
				<div class="container">
					<h2>Game on!</h2>
					<p>Fusce erat dui, venenatis et erat in, vulputate dignissim lacus. Donec vitae tempus dolor,<br>sit amet elementum lorem. Ut cursus tempor turpis.</p>
					<a href="#" class="site-btn">Read More  <img src="{{asset('user/img/icons/double-arrow.png')}}" alt="#"/></a>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="intro-text-box text-box text-white">
						...
						<a href="#" class="read-more">Read More  <img src="{{asset('user/img/icons/double-arrow.png')}}" alt="#"/></a>
					</div>
				</div>
				<div class="col-md-4">
					<div class="intro-text-box text-box text-white">
					...
					<div id="stickySidebar">
						<div class="widget-item">
							...
							<div class="trending-widget">
								<div class="tw-item">
									<div class="tw-thumb">
										<img src="{{asset('user/img/blog-widget/1.jpg')}}" alt="#">
									</div>
									<div class="tw-text">
								...
								<div class="tw-item">
									<div class="tw-thumb">
										<img src="{{asset('user/img/blog-widget/2.jpg')}}" alt="#">
									</div>
									<div class="tw-text">
										<div class="tw-meta">11.11.18  /  in <a href="">Games</a></div>
										<h5>The best online game is out now!</h5>
								...
								<div class="tw-item">
									<div class="tw-thumb">
										<img src="{{asset('user/img/blog-widget/3.jpg')}}" alt="#">
									</div>
									<div class="tw-text">
										<div class="tw-meta">11.11.18  /  in <a href="">Games</a></div>
										<h5>The best online game is out now!</h5>
								...
								<div class="tw-item">
									<div class="tw-thumb">
										<img src="{{asset('user/img/blog-widget/4.jpg')}}" alt="#">
									</div>
									<div class="tw-text">
										<div class="tw-meta">11.11.18  /  in <a href="">Games</a></div>
										<h5>The best online game is out now!</h5>
	...
	<!-- Intro section -->
	<section class="intro-video-section set-bg d-flex align-items-end " data-setbg="{{asset('user/img/promo-bg.jpg')}}">
		<a href="https://www.youtube.com/watch?v=uFsGy5x_fyQ" class="video-play-btn video-popup"><img src="{{asset('user/img/icons/solid-right-arrow.png')}}" alt="#"></a>
		<div class="container">
	...
	<section class="featured-section">
		<div class="featured-bg set-bg" data-setbg="{{asset('user/img/featured-bg.jpg')}}"></div>
	...
	<section class="newsletter-section">
		<div class="container">
			...
			<form class="newsletter-form">
				...
				<button class="site-btn">subscribe  <img src="{{asset('user/img/icons/double-arrow.png')}}" alt="#"/></button>
			</form>
		</div>
	</section>
	...
	<footer class="footer-section">
		<div class="container">
			<div class="footer-left-pic">
				<img src="{{asset('user/img/footer-left-pic.png')}}" alt="">
			</div>
			<div class="footer-right-pic">
				<img src="{{asset('user/img/footer-right-pic.png')}}" alt="">
			</div>
	...
	<script src="{{asset('user/js/jquery.slicknav.min.j')}}s"></script>
